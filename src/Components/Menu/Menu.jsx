...
export default function Menu({menuOpen, setMenuOpen}){
  ...
  return(<>
    ...
    <aside className="h-full w-full sm:w-96 lg:w-112 bg-primary absolute top-0 right-0 text-3xl overflow-hidden">
      ...
      <section className="w-full flex flex-col items-end text-3xl">

        <div className="py-5 flex items-center justify-end w-full mr-5">
          <input type= "text" className="w-57.5 bg-secondary placeholder:text-lg py-2 pl-2 rounded sm:w-2/3 lg:placeholder:text-xl border-tertiary border-1 focus:border-primary focus:outline-tertiary text-xl " placeholder="Search"></input>
        </div>
